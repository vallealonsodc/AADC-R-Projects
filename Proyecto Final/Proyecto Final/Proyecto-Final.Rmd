...
Por tanto, los datos utilizados se han extraído directamente de la página oficial del Reporte Mundial de Felicidad [2]. Estos datos se encontraron en formato xls en un excel. Una de las tareas principales del análisis ha sido limpiar los datos. Primero limpiando el excel para que sea legible por la función R correspondiente y posteriormente
...
- Visualizacion
- Resultados muy distintos en algunos momentos de correlacion han pasado 7 años
- Problemas con los datos en algunos momentos 
